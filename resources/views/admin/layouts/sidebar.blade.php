                ...
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <!--   <div class="nav-item">
                        ...
                        <div class="nav-item has-sub">
                            <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Admin</span> <span class="badge badge-danger"></span></a>
                    ...
                    @endif
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <div class="submenu-content">
                                <a href="#" class="menu-item">Patients(today)</a>
                                <a href="#" class="menu-item">All patients(prescription)</a>
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <div class="submenu-content">
                                <a href="{{route('patient.index')}}" class="menu-item">Today Appointment</a>
